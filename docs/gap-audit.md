...
| rails(57 文件/143 符号) | partial(P2-02 work package done) | ShellGuard/PathGuard/ToolBudget/ApprovalRail + sandbox/security rail + tiered policy shell/network URL/query 分层匹配 + P2-02 differential | heartbeat、lsp、mcp、memory、skills、context_engineer、subagent verification、tool_call_resilience、sys_operation、agent_mode、_multimodal 等更大 Python harness rail 模块仍未完整移植 |
